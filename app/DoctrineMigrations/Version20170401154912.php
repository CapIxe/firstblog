 ...
 */
class Version20170401154912 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE draft status TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE status draft TINYINT(1) NOT NULL');
    }
}
